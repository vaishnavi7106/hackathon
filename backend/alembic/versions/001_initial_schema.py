...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("irrigation_plan", postgresql.JSONB, nullable=False, server_default=sa.text("'[]'::jsonb")),
        sa.Column("water_cost_est", sa.Numeric(8, 2), nullable=True),
        sa.Column("joint_calendar", postgresql.JSONB, nullable=False, server_default=sa.text("'[]'::jsonb")),
    ...
    op.create_table(
        ...
        sa.Column("forecast_data", postgresql.JSONB, nullable=False, server_default=sa.text("'[]'::jsonb")),
